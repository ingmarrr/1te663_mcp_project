...
#define LCD_DATA0_PIN    5            /**< pin for 4bit data bit 0  */ /*prev: PB4*/
#define LCD_DATA1_PIN    4            /**< pin for 4bit data bit 1  */  /*prev: PB5*/
#define LCD_DATA2_PIN    7           /**< pin for 4bit data bit 2  */  /*prev: PB2*/
#define LCD_DATA3_PIN    6            /**< pin for 4bit data bit 3  */  /*prev: PB3*/
